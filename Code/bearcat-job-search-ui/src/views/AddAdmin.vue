        ...
        <div class="col-md-6 v-center">
          ...
          <small v-if="error.username" class="col-12 text-left text-danger">{{
           ...
           <base-input
            ...
            required
          ></base-input>
          <small v-if="error.userOrganization" class="col-12 text-left text-danger">{{
            error.userOrganization
          }}</small>
           <base-input
            type="text"
            ...
            required
          ></base-input>
          <small v-if="error.userOrganizationDescription" class="col-12 text-left text-danger">{{
            error.userOrganizationDescription
          }}</small>
           <base-input
            type="text"
