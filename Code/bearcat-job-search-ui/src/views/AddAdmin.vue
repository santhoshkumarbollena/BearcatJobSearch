        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 v-center">
                    ...
                    <base-input type="text" placeholder="User Name" addon-left-icon="fa fa-briefcase" v-model="form.userName" required></base-input>
                ...
                error.username
                    ...
                    <base-input type="text" placeholder="User Organization" addon-left-icon="fa fa-money" v-model="form.userOrganization" required></base-input>
    
                    <small v-if="error.userOrganization" class="col-12 text-left text-danger">{{ error.userOrganization }}</small
              ...
              <small v-if="error.phone" class="col-12 text-left text-danger">{{
                ...
                error.phone
                    ...
                    <base-input type="text" placeholder="Email" addon-left-icon="fa fa-money" v-model="form.email" required></base-input>
                ...
                error.email
                    ...
                    <base-input type="password" placeholder="Password" addon-left-icon="fa fa-money" v-model="form.password" required></base-input>
                ...
                error.email
                    ...
                    <base-input addon-left-icon="fa fa-calendar">
                        ...
                        <flat-picker slot-scope="{ focus, blur }" @on-open="focus" @on-close="blur" :config="{ allowInput: true }" class="form-control datepicker" v-model="form.dob" placeholder="DOB"></flat-picker>
                ...
                error.dob
                    ...
                    <b-form-radio-group v-model="form.gender" :options="options" class="mb-3" value-field="item" text-field="name" disabled-field="notEnabled"></b-form-radio-group>
    
                    <base-button type="primary" class="btn pull-left mt-3 btn-icon btn-primary" icon="fa fa-save" @click.prevent.stop="add">Add Admin</base-button>
    
                    <router-link to="/home">
    
                        <base-button type="danger" class="btn pull-right mt-3 btn-icon btn-primary" icon="fa fa-ban">Cancel</base-button>
