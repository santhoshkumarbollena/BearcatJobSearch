    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 v-center">
          ...
          <base-input type="text" placeholder="Question" v-model="form.faqQuestion" required></base-input>
          ...
          <textarea
            ...
            rows="2"
          ></textarea>
          <small v-if="error.faqAnswer" class="col-12 text-left text-danger">{{ error.faqAnswer }}</small>

          <label for="category" class="font-weight-bold">Category:</label>
          <base-input type="text" placeholder="Category" v-model="form.category" required></base-input>
          <small v-if="error.category" class="col-12 text-left text-danger">{{ error.category }}</small>

          <label for="role" class="font-weight-bold">Role:</label>
          <base-input type="text" placeholder="Role" v-model="form.role" required></base-input>
  ...
  methods: {
    add() {
      ...
      if (!this.form.category) {
        this.error.category = "Enter Category";
      }
      ...
      this.$http
        ...
        .then(response => {
          this.$root.$bvToast.toast(`New FAQ added successfully`, {
            title: "Success",
            autoHideDelay: 5000,
            variant: "success"
          });
